...
public class TechnologicalCardRepository
{
    ...
    public string getImageBase64(TechnologicalCard tc)
    {
        var imageBase64 = _db.ImageStorage.Where(i => i.Id == tc.ExecutionSchemeImageId).Select(u => u.ImageBase64).FirstOrDefault();
        return imageBase64;
    }
