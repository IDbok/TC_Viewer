...
public class TechnologicalCardRepository
{
    ...
    //public async Task<TechnologicalCard> GetTechnologicalCardAsync(int Id,  MyDbContext context = null)
    //{
    //    var tc = await gettcasync(id, context);
    //    tc.techoperationworks = await gettowdataasync(id, context);
    //    tc.diagamtowork = await getdtwdataasync(id, context);
    ...
    public async Task<TechnologicalCard> GetTCDataAsync(int _tcId, bool advancedQuery = false)
    {
        try
        {
    ...
    public async Task<List<TechOperationWork>> GetTOWDataAsync(int _tcId, bool advancedQuery = false)
    {
        using (MyDbContext context = new MyDbContext())
        {
    ...
    public async Task<List<DiagamToWork>> GetDTWDataAsync(int _tcId, bool advancedQuery = false)
    {
        using (MyDbContext context = new MyDbContext())
        {
